...
❌Took a loss here, onto next❌ (${numbers[0]}, ${numbers[1]})
    ...
    function main() {
        ...
        const tableElements = document.querySelectorAll('.lobbyList');


        tableElements.forEach((_, index, arr) => {
            const numbers = [];

            const title = document.querySelectorAll('.lobbyList .tableName')[index].getAttribute("title")

            tableElements[index].querySelectorAll(".svg_div text").forEach(el => {
